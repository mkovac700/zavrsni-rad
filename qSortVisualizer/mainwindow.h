...
private slots:
    ...
    void on_toolButtonRandomRange_clicked();

    void on_checkBoxLogarithmize_stateChanged(int arg1);

    void on_horizontalSliderRefreshFreq_valueChanged(int value);

    void on_pushButtonClearReports_clicked();
...
//    QTimer *statisticsTimer;
    ...
    //STATUSBAR
    QString visualizationLastMessage, statisticsLastMessage;
};
#endif // MAINWINDOW_H
